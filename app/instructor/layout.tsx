  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 font-sans selection:bg-[#BFFF00] selection:text-black ${theme} ${theme === 'dark' ? 'bg-[#030303] text-zinc-100' : 'bg-[#F9FAFB] text-zinc-900'}`}>
      ...
      <div className="lg:pl-64 min-h-screen relative z-10">
        ...
        <header className={`sticky top-0 z-40 h-16 sm:h-20 px-4 sm:px-8 md:px-12 flex items-center justify-between transition-all duration-300 ${
          scrolled 
          ...
          : ''
           ...
           <div className="flex-1 max-w-xl relative hidden md:block">
              ...
              <input 
                ...
                className={`w-full pl-12 pr-4 py-2.5 rounded-xl border transition-all text-sm focus:outline-none ${
                   theme === 'dark' 
           ...
           <div className="flex items-center gap-2 sm:gap-4 ml-auto">
              <button 
                ...
                className={`flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl border transition-all text-[10px] sm:text-[11px] font-black uppercase tracking-widest ${
                  theme === 'dark' 
