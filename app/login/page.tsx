...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] text-zinc-900 selection:bg-[#BFFF00] selection:text-black overflow-x-hidden relative flex items-center justify-center p-4 sm:p-6 font-sans">
      <CustomCursor />

      {/* Soft Ambient Background Orbs */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] rounded-full bg-[#BFFF00]/10 blur-[100px]" />
      ...
      >
        ...
        <div className="rounded-[2rem] sm:rounded-[2.5rem] bg-white p-8 sm:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-zinc-100 space-y-10 sm:space-y-12">
          <div className="space-y-4">

            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-900 leading-tight">Welcome Back.</h1>
            <p className="text-xs sm:text-sm text-zinc-500 font-medium leading-relaxed">Sign in to your learning dashboard to continue your progress.</p>
          </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="email"
                      required
                      className="block w-full rounded-2xl border border-zinc-200 bg-zinc-50/50 pl-14 pr-6 py-4 text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:border-zinc-900 focus:bg-white transition-all text-sm"
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center ml-1">
                    <label className="text-[11px] font-bold uppercase tracking-widest text-zinc-400" htmlFor="password">
                      Password
                    </label>
                    <Link href="#" className="text-[10px] font-bold text-zinc-400 hover:text-zinc-900 transition-colors underline underline-offset-4">Forgot password?</Link>
                  </div>
                  <div className="relative">
                    <div className="absolute left-5 top-1/2 -translate-y-1/2 text-zinc-300">
          ...
          <div className="pt-8 text-center border-t border-zinc-100">
            <p className="text-sm text-zinc-500 font-medium">
              Don't have an account? <Link href="/register" className="font-bold text-zinc-900 hover:underline underline-offset-4">Sign up for free</Link>
            </p>
          </div>
        </div>

        <div className="mt-12 text-center pointer-events-none opacity-40">
          <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-zinc-400">Adaptive. Educational infrastructure</span>
        </div>
      </motion.div>
    </div>
  );
