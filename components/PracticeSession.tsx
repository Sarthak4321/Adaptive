               ...
               {question.options.map((option, index) => {
                  ...
                  return (
                     <button
                        ...
                        className={`w-full group flex items-center p-3.5 sm:p-7 rounded-xl sm:rounded-[2rem] border-2 transition-all duration-300 text-left ${
                           isSelected 
                     ...
                     >
                        <div className={`h-7 w-7 sm:h-11 sm:w-11 rounded-md sm:rounded-2xl flex items-center justify-center text-[10px] sm:text-sm font-black mr-3 sm:mr-6 transition-all ${
                           isSelected ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-400 group-hover:bg-blue-500 group-hover:text-white'
                        }`}>
